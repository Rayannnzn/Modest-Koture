      ...
      <div className="container mx-auto px-4 lg:px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {vendors.map((vendor) => (
            <div
              key={vendor.id}
              className="group relative bg-white rounded-xl overflow-hidden border border-border hover:border-[#c9a96e]/30 hover:shadow-premium transition-all duration-300 flex flex-col h-full"
            >
              ...
              <div className="p-5 pt-0 relative flex flex-col flex-1">
                ...
                <div className="flex justify-between items-end mb-4 -mt-8 relative z-10">
                  ...
                  {/* Follow button — z-10 to stay above stretched link */}
                  <button
